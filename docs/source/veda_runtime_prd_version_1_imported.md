<!-- Imported from D:\EXTR\veda_runtime_prd_v1.2_fixed.md on 2026-05-09. Product-facing v1.2 labels normalized to Version 1. HANDOFF_JSON v6.1.1 is intentionally unchanged. -->

# VEDA Runtime — Product Requirements Document Version 1
...
> **Version 1 Fix Log (adversarial audit pass)**
>
> | # | Severity | Fix |
> |---|---|---|
...
> | 5 | HIGH | Added Version 1 migration note for nonce registry filename `.json` → `.jsonl` (§9.2) |
...
## 0. Version 1 Executive Mandate

VEDA Runtime Version 1 is not a feature expansion release. It is a production hardening release.
...
VEDA Runtime Version 1 promotes five things from “architecture idea” to “release blocker”:
...
Version 1 consolidates five source layers:
...
Version 1 does not blindly merge all suggestions. It accepts the useful ones, rejects unsafe/ambiguous ones, and locks the runtime around verifiable gates.
...
| Capability | Version 1 Status | Release Meaning |
|---|---:|---|
...
| Redis/BullMQ queue | BLOCKED/OPTIONAL | Do not block local Version 1 on Redis; use local sequential queue fallback |
...
## 6. System Architecture Version 1
...
Version 1 can support a local queue without Redis/BullMQ for the first production-verified workflow.
...
export interface VedaTraceSpan {
  ...
  agent_name: string;
  agent_version: string;   // canonical: agent version string e.g. "Version 1"
  event_type: string;
  timestamp: string;
  status: SpanStatus;
  prev_hmac: string;
...
## 12. Governance Injection Layer Version 1
...
## 14. Capability Router Version 1
...
## 15. Execution Sandbox Version 1
...
## 17. Observability Engine Version 1
...
## 18. Sovereign Audit Ledger Version 1
...
## 19. Compliance Scope Version 1

Compliance claims must remain conservative.

VEDA Runtime can provide compliance-supporting infrastructure, but Version 1 must not claim full legal compliance until gates are live and audited.
...
## 20. Live Status Dashboard Version 1
...
## 21. MVP Scope Version 1

### 21.1 Included in Version 1 Foundation Release
...
| Risk | Severity | Version 1 Mitigation |
|---|---:|---|
...
## 28. Final Version 1 Verdict

VEDA Runtime is a strong product idea only if it stops trying to prove scale before it proves execution integrity.

Version 1 should not add more agents, more departments, more orchestration, or more compliance language.

Version 1 should do one thing extremely well:
